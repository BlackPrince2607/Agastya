        ...
        <ScrollView
          ...
          <View className="mb-10 gap-3">
            <View className="flex-row items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.06] p-4">
              <View
                className="h-11 w-11 shrink-0 items-center justify-center rounded-full border border-primary/25 bg-primary-container">
            ...
            <View className="flex-row gap-3">
              <View className="min-h-[124px] flex-1 items-start rounded-2xl border border-white/10 bg-white/[0.06] p-4">
                <View
                  className="h-11 w-11 items-center justify-center rounded-full border border-tertiary/30 bg-primary-container/75">
                  <Ionicons name="hand-left-outline" size={22} color={colors.tertiary} />
                </View>
              ...
              <View className="min-h-[124px] flex-1 items-start rounded-2xl border border-white/10 bg-white/[0.06] p-4">
                <View
                  className="h-11 w-11 items-center justify-center rounded-full border border-on-secondary-container/30 bg-primary-container/75">
                  <Ionicons name="sparkles-outline" size={22} color={colors.onSecondaryContainer} />
                </View>
                <Text className="mt-auto font-label text-[12px] uppercase leading-4 tracking-[0.12em] text-on-surface">
                  Daily guidance
                </Text>
