      ...
      <View className="overflow-hidden rounded-4xl border border-white/18">
        <LinearGradient
          ...
          <LinearGradient colors={['rgba(5,2,14,0.08)', 'rgba(10,12,42,0.62)']} style={{ padding: 26 }}>
            <Text className="text-[13px] font-semibold uppercase tracking-[0.35em] text-white/90">Aura resonance</Text>
            <Text className="mt-4 text-[24px] font-semibold tracking-tight text-white">{aura.label}</Text>
            <Text className="mt-4 max-w-[88%] text-[14px] leading-6 text-white/88">
